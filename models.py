...
class User(db.Model):
  ...
  categories = db.relationship('Category', backref='user', lazy='joined')
  ...
  def add_todo_category(self, todo_id, category_text):
    """Adds a category to a todo, creating the category if necessary."""
    ...
    # Associate todo with category if not already linked
...
class Todo(db.Model):
  ...
  # Relationship with categories through the bridge table
